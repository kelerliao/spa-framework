...
(function () {
    ...
    tcss.prototype = {
        ...
        getDomainInfo: function (e) {
            ...
            e && (Tcss.dm += ".hot"), "dm=" + Tcss.dm + "&url=" + Tcss.url
        },
...
const stats = {
    click: (hotTag) => {
        let url = 'http://pinghot.qq.com/pingd?',
            params;

        params = {
            dm: location.hostname + '.hot',
            url: location.pathname,
            hottag: hotTag,
            hotx: 9999,
            hoty: 9999,
            rand: Math.round(Math.random() * 1e5)
        };

        // url += util.toParams(params);
        ...
        // dm=show.qq.com.hot
        // url=/qqshow/v5/fashion/html/index/index_f.html
        // hottag=show5.index.pv
        // hotx=9999
        // hoty=9999
        // rand=37290
    }
